...
const Newsletter = () => {
  return (
    <section>
      <div className="flex md:flex-row flex-col border border-green-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-7xl bg-white p-8">
        {/* left */}
        ...
        {/* Right */}
        <div className="space-y-4 md:max-w-48 max-md:py-5">
